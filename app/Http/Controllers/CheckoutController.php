...
//if value="cash_on_delivery" then store data and redirect to checkout page value="bank_trasnfer" then store data and redirect to bank transfer page
        ...
        if ($request->payment_type == 'cash_on_delivery') {
            ...
            else if ($request->payment_type == 'bank_trasnfer') {
                $validatedData = $request->validate([
                    'name' => 'required|string',
                    'last_name' => 'required|string',
                    'email' => 'required|email',
