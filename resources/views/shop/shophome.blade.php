                ...
                <div class="accordion-item mb-4 pb-3">
                    ...
                    <div id="accordion-filter-1" class="accordion-collapse collapse " aria-labelledby="accordion-heading-11" data-bs-parent="#categories-list">
                        <div class="accordion-body px-0 pb-0 ">
                            <ul class="accordion-collapse collapse show border-0">
                                @foreach($category as $Category)
                                    <li class="list-item">
                                        <a href="{{ url('view-category/'.$Category->id) }}" class="menu-link py-1">{{ $Category->name }}</a>
                                    </li>
                                @endforeach
                                <li class="list-item">
                                    <a href="{{ url('view-all-products') }}" class="menu-link py-1">Show All Products</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="shop-list flex-grow-1">
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                    ...
                    <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium" >Smart Farmer's Shop</a>
                </div><!-- /.breadcrumb -->
                                ...
                                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="{{ url('more/'.$Product->slug) }}"><img loading="lazy" src="{{ asset('uploads/product/'.$Product->image) }}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img"></a>
                                        </div><!-- /.pc__img-wrapper -->
                                        <div class="swiper-slide">
                                            <a href="{{ url('more/'.$Product->slug) }}"><img loading="lazy" src="{{ asset('uploads/product/'.$Product->image) }}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img"></a>
                                        </div><!-- /.pc__img-wrapper -->
...
{{--                          --}}  </div>
                            ...
                            <div class="pc__info position-relative">
                                ...
                                <h6 class="pc__title"><a href="{{ url('more/'.$Product->slug) }}">{{ $Product->name }}</a></h6>
