                ...
                <div class="checkout-form">
                    <div class="billing-info__wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating my-3">
                                    <input type="text" value="{{ Auth::user()->name }}" class="form-control"
                                        id="checkout_first_name" placeholder="First Name" name="name">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" id="checkout_country"
                        ...
                        <div class="col-md-12">
                            <div class="mt-3">
                                <textarea name="order_notes" class="form-control form-control_gray" placeholder="Order Notes (optional)"
                    ...
                    <div class="checkout__totals-wrapper">
                        <div class="sticky-content">
                            ...
                            <button class="btn btn-primary btn-checkout" id="place-order-btn">PLACE ORDER</button>
