                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                                aria-current="page">New Farmer's Products</span>
                                        </div>
                                    </li>
                                </ol>
                            </nav>
                            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Farmer's Products
                            </h1>
                        </div>
                        <div
                                    ...
                                    <tbody
                                        ...
                                        @foreach($ads as $Product)
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <img src="{{ asset('uploads/product/'.$Product->image) }}" alt="image here" style="width: 80px"></td>
                                                ...
                                                <td
                                                    class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $Product->status == '0' ?'Pending' : 'Completed' }}</td>
                                                <td
                                                    class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    Rs. {{ $Product->original_price }}</td>
                                                    ...
                                                    <td class="py-4 pl-4 pr-3 text-sm font-medium">
                                                        <div class="flex gap-3">
                                                            <a href="{{ url('viewsellpro/' . $Product->id) }}"
                                                                class="rounded-md  px-4 py-2 text-sm font-semibold text-white hover:bg-red-600 transition-all duration-300" style="background-color: green">View</a>
