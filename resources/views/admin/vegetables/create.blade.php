<x-admin-layout>
    <h2 class="font-semibold text-xl text-gray-600 ml-10 pb-2">Add Vegetables</h2>
    <form action="{{ url('vegetable-add') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg overflow-hidden shadow-md px-8 pt-6 pb-8 mb-4 ml-10 mr-10">
        @csrf
        <div class="mb-4 flex">
