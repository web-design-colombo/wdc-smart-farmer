                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                                aria-current="page">Ads</span>
                                        </div>
                                    </li>
                                </ol>
                            </nav>
                            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Ads
                            </h1>
                        </div>
                        <div
                            ...
                            <a href="{{  url('/product') }}">
                                <button
                                    ...
                                    type="button" style="background-color: rgb(5, 131, 5)">
                                    Add new Product
                                </button></a>
                        </div>
                    </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                    ...
                                    <tbody
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td  class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400"><img src="{{ asset('uploads/shopads/'.$ads->image) }}" alt="image here" style="width: 60px"></td>
                                                ...
                                                <td
                                                    ...
                                                    <td  class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{{ $ads->phone_number }}</td>
                                                    <td  class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{{ $ads->shop_address }}</td>
                                                    ...
                                                    <td  class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{{ $ads->status == '0' ?'Pending' : 'Completed' }}</td>
