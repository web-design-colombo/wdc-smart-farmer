                ...
                <div
                    ...
                    <div class="w-full mb-1">
                        <div class="mb-4">
                            ...
                            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Orders
                            </h1>
                        </div>
                        <div
                            ...
                            <div class="flex items-center mb-4 sm:mb-0">
                                ...
                                <form action="{{ url('sortorders') }}" method="get" class="search-field container">
                                    @csrf
                                    <div class="col-lg-12 shop-one__sorter">
                                        <select class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" name="sort" id="sort" onchange="this.form.submit()">
                                            <option value="" disabled selected>Sort By</option>
                                            <option value="best_selling">Newest</option>
                                            <option value="lowest_price">Oldest</option>
                                            <option value="highest_price">Highest Price Order</option>
                                            <option value="highest_price">Lowest Prices Order</option>
                                        </select>
                                    </div>
                                </form>
                                    ...
                                    <tbody
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td
                                                    ...
                                                    {{ $order->status == '0' ?'Pending' : 'Delivered' }}</td>
