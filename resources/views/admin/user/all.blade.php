<x-admin-layout>
                ...
                <div
                    ...
                    <div class="w-full mb-1">
                        <div class="mb-4">
                            ...
                            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Users
                            </h1>
                        </div>
                        <div
                                ...
                                <form action="{{ url('adminsearch') }}" method="get"
                                    ...
                                    <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                                        <input
                                            ...
                                            type="search" placeholder="Search here" id="Search_productsadmin"
                                            name="search">
                                        ...
                                        @foreach ($users as $Product)
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap">
                                                    ...
                                                    <a href="{{ url('edituser/' . $Product->id) }}">
                                                        <button type="button"
                                                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                                            style="background-color: rgb(5, 131, 5)">
                                                    ...
                                                    <form action="{{ url('deleteuse/' . $Product->id) }}"
    ...
    <script>
        $(document).ready(function() {
            cartCount();
            $('#Search_productsadmin').autocomplete({
                source: function(request, response) {
                    $.ajax({
                        url: "{{ url('product-listadmin') }}",
                        type: 'GET',
                        data: {
                            term: request.term
                        },
