<x-admin-layout>
    <div id="product-categories-content" class="content-container bg-green-50 p-6 rounded-md">
        <!-- Product Categories content goes here -->
        <div class="left">
            @if (session('success'))
            ...
            <div class="mt-8">
                <div class="mt-8 overflow-x-auto">
                    <table class="min-w-full bg-white divide-y divide-gray-300 rounded-lg overflow-hidden">
                        <thead class="bg-green-500 text-white">
                            <tr>
                                ...
                                <th class="px-3 py-3.5 text-left text-sm font-semibold">Slug</th>
