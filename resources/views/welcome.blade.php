    ...
    <div class="swiper-container thm-swiper__slider"
        ...
        <div class="swiper-wrapper" style="margin-top: -100px">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(assets/images/backgrounds/main-slider-v1-1.jpg);">
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="main-slider-inner">
                                <div class="main-slider__content">
                                    <span class="main-slider-tagline">We're giving good service to you</span>
                                    <h2 class="main-slider__title">Welcome to <br> Smart <span><span
                                                class="leaf"><img src="assets/images/resources/leaf.png"
                                                    alt="" /></span>Farmer</span></h2>
                                    <p class="main-slider__text">Choose the right seeds, grow with advanced methods and new Techniques, and harvest
                                        successfully.
                                      <br>  Your complete guide to modern agriculture.</p>
                                </div>
                                <div class="main-slider__button-box">
                                    <div class="arrow-icon"><img src="assets/images/icon/main-slider__button-arrow.png"
                                            alt="" />
                                    </div>
            ...
            <!--Start Single Swiper Slide-->
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(assets/images/backgrounds/main-slider-v1-2.jpg);">
                </div>
                <div class="image-layer-overlay"></div>
                <div class="container">
                    <div class="row">
            ...
            <!--Start Single Swiper Slide-->
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(assets/images/backgrounds/main-slider-v1-3.jpg);">
                </div>
                <div class="image-layer-overlay"></div>
                <div class="container">
                    <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contact-one__content">
                    ...
                    <div class="contact-one__images">
                        ...
                        <img src="https://pixydrops.com/agriox/assets/images/resources/contact-1-1.png" alt=""
                            class="contact-one__images-1">
                        <img src="https://pixydrops.com/agriox/assets/images/resources/contact-1-2.png" alt=""
                            class="contact-one__images-2">
                    </div><!-- /.contact-one__images -->
                </div><!-- /.contact-one__content -->
            </div><!-- /.col-lg-6 -->
            <div class="col-lg-6">
                <form action="https://pixydrops.com/agriox/assets/inc/sendemail.php"
